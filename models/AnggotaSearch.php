...
class AnggotaSearch extends Anggota
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama_anggota', 'nik', 'jenis_kelamin', 'tempat_lahir', 'tgl_lahir', 'golongan_darah', 'alamat', 'status_pernikahan', 'status_dalam_keluarga', 'pendidikan', 'created_at', 'updated_at', 'jenis_anggota', 'nama_kecamatan', 'nama_desa'], 'safe'],
        ];
    }
     ...
     */
    public function search($params, $budidaya = false)
    {
        ...
        if ($budidaya) {
            $query->andWhere(['jenis_anggota' => 'BUDIDAYA']);
        }
